...
2023년 1월부터 2024년 12월까지의 시간대별 이용정보를 바탕으로 Daily Naive, Weekly Naive, SARIMA, LightGBM을 동일한 테스트 기간에서 비교했습니다.
...
시간 순서 기반 학습·검증·테스트 분할
            ↓
Daily Naive / Weekly Naive / SARIMA / LightGBM
            ↓
